...
const VolleyballForm = () => {
  ...
  return (
    <Container maxWidth="sm">
      <Typography variant="h4" align="center" gutterBottom>
        แบบฟอร์มลงทะเบียนกีฬาวอลเลย์บอล
      </Typography>
  ...
  <TextField
    ...
    required
  >
    <MenuItem value="วอลเลย์บอล ชาย">วอลเลย์บอล ชาย</MenuItem>
    <MenuItem value="วอลเลย์บอล หญิง">วอลเลย์บอล หญิง</MenuItem>
