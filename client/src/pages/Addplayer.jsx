...
const Addplayer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/players/addplayer', data, {
  ...
  return (
    ...
    <Typography variant="h4" gutterBottom sx={{ textAlign: 'center', mb: 3, color: '#333' }}>เพิ่มข้อมูลนักกีฬา</Typography>
