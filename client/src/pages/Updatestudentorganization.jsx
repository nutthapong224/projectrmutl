...
const UpdatedStudentOrganization = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`http://localhost:5000/api/studentorgranization/player/${id}`)
        .then(response => {
          ...
          // Set selectedOrganization directly
          setSelectedOrganization(playerData.position);
  ...
  // Effect for updating position in formData when selectedOrganization changes
  useEffect(() => {
    if (selectedOrganization) {
      console.log("Selected organization:", selectedOrganization);
      // Update formData with the new selectedOrganization
      setFormData(prev => {
        const updated = { ...prev, position: selectedOrganization };
        console.log("Updated formData position:", updated.position);
        return updated;
      });
    }
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Selected organization at submission time:", selectedOrganization);
    ...
    try {
      const response = await axios.put(`http://localhost:5000/api/studentorgranization/update-registration/${id}`, data, {
        headers: { 'Content-Type': 'multipart/form-data' }
      });
      console.log("Server response:", response.data);
      alert('อัพเดทข้อมูลสำเร็จ!');
      navigate("/admindashboard/manage/studentorgranization");
    } catch (error) {
              ...
              <FormControl fullWidth required>
                ...
                <Select 
                  ...
                  onChange={(e) => {
                    ...
                    console.log("Organization selected:", selectedValue); // Debug
...
export default UpdatedStudentOrganization;