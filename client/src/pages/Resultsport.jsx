...
const Resultsport = () => {
    ...
    const handleClick = (id) => {
        ...
        navigate(`/admindashboard/updatematchresult/${id}`);
    };
                        ...
                        <Table>
                            <TableHead>
                                ...
                                <TableCell>ประเภทกีฬา</TableCell>
                                    <TableCell>ทีม1</TableCell>
                                    <TableCell>สกอ</TableCell>
                                    <TableCell>ทีม2</TableCell>
                            ...
                            <TableBody>
                                {pendingUsers.map((user) => (
                                    <TableRow key={user.id}>
                                        ...
                                        <TableCell>{user.team1}</TableCell>
                                  
                                        <TableCell>{user.team1score}-{user.team2score}</TableCell>
                                   
                                        <TableCell>{user.team2}</TableCell>
                                        <TableCell>{user.winner}</TableCell>

                                        <TableCell><img src={`http://localhost:5000${user.profile_image}`} alt="" width={50} /></TableCell>
