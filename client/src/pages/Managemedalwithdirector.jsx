...
const Managemedalwithdirector = () => {
    ...
    const handleClick = (id) => {
        navigate(`/directordashboard/updatemedalplayer/${id}`);
    };
        ...
        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                ...
                <Button
                    variant="contained"
                    color="primary"
                    onClick={() => navigate("/directordashboard/addmedal")}
                >
                    เพิ่มข้อมูล
                </Button>
            </Box>
...
export default Managemedalwithdirector;