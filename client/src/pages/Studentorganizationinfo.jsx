...
const Studentorganizationinfo = () => {
  ...
  useEffect(() => {
    const fetchPlayerDetails = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/studentorgranization/player/${id}`);
        ...
        <CardContent>
          ...
          {!flip && player && (
            <>
              ...
              >
                <span>ชื่อสกุล : </span>
                {player.title}  {player.fname} {player.lname}
              </Typography>
              <Typography
                variant="body2"
                sx={{
              ...
              >
                <span>ทำหน้าที่: </span>
                {player.position}{player.sport_type}
              </Typography>
              <Typography
                variant="body2"
                sx={{
...
export default Studentorganizationinfo;
