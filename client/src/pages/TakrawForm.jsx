...
const TakrawForm = () => {
  ...
  return (
    <Container maxWidth="sm">
      <Typography variant="h4" align="center" gutterBottom>
        แบบฟอร์มลงทะเบียนกีฬาเซปักตะกร้อ
      </Typography>
  ...
  <TextField
    ...
    required
  >
    <MenuItem value="เซปักตะกร้อ ทีมเดี่ยวชาย">เซปักตะกร้อ ทีมเดี่ยวชาย</MenuItem>
    <MenuItem value="เซปักตะกร้อ ทีมคู่ (2 คน) ชาย">เซปักตะกร้อ ทีมคู่ (2 คน) ชาย</MenuItem>
    <MenuItem value="เซปักตะกร้อ ทีมชุดชาย">เซปักตะกร้อ ทีมชุดชาย</MenuItem>
    <MenuItem value="เซปักตะกร้อ ทีมเดี่ยวหญิง">เซปักตะกร้อ ทีมเดี่ยวหญิง</MenuItem>
  </TextField>
</Grid>
          <Grid item xs={12}>
