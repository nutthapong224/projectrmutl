...
const FootballForm = () => {
  ...
  <TextField
    ...
    required
  >
    <MenuItem value="ฟุตบอลชาย">ฟุตบอลชาย</MenuItem>
    <MenuItem value="ฟุตบอลหญิง">ฟุตบอลหญิง</MenuItem>
  </TextField>
</Grid>
          <Grid item xs={12}>
